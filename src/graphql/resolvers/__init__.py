...
from .recipes import RecipeQuery, RecipeMutation
...
class Query():
    ...
    recipe: RecipeQuery = strawberry.field(resolver=RecipeQuery)
...
class Mutation():
    ...
    recipe: RecipeMutation = strawberry.field(resolver=RecipeMutation)
