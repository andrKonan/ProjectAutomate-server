# server/src/graphql/resolvers/recipes.py
...
from src.database.services import RecipeService
from src.graphql.schemas.recipes import RecipeScheme
from src.graphql.inputs.recipes import RecipeInput
